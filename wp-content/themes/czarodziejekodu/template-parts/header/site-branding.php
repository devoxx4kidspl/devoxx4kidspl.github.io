<div class="site-branding">
	...
	<?php endif; ?>
			<h1>
				<a id="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img alt="czarodzieje kodu logo" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/czarodziejekodu/images/logo.png"></a>
